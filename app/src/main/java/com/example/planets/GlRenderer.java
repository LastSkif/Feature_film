...
class GlRenderer implements Renderer {
    ...
    float p2;
    float p3;
    private static final int AXIAL_TILT_DEGREES = 10;
    ...
    private static final float OBJECT_DISTANCE = -7.5f;
    ...
    public GlRenderer(final Context context) {
        ...
        this.mSun = new Sphere(1, 3);
        this.mEarth = new Sphere(2, 0.4f);
        this.mMoon = new Sphere(2, 0.25f);
    ...
    public void onSurfaceChanged(final GL10 gl, final int width, final int height) {
        ...
        gl.glLoadIdentity();
        GLU.gluPerspective(gl, 110.0f, (float) width / height, 0.1f, 40.0f);
    ...
    public void onSurfaceCreated(final GL10 gl, final EGLConfig config) {
        ...
        this.mSun.loadGLTexture(gl, this.mContext, R.drawable.eyes_hehe);
